...
impl Tokenizer {
    ...
    pub fn tokenize(&mut self) {
        ...
        while current_char != '\0' {
            ...
            let is_word = current_char.is_ascii_alphanumeric()
                ...
                || (current_char == '.'
                    && !char_stack.is_empty()
                    && char_stack.chars().all(|c| c.is_ascii_digit()));
            ...
            match current_char {
                ...
                '+' => match self.peakNextChar() {
                    '+' => {
                        self.pushDouble(TokenType::PlusPlus);
                        self.char_index += 1;
                    }
                    '=' => {
                        self.pushDouble(TokenType::PlusEquals);
                        self.char_index += 1;
                    }
                ...
                '-' => match self.peakNextChar() {
                    '>' => {
                        self.pushDouble(TokenType::Arrow);
                        self.char_index += 1;
                    }
                    '-' => {
                        self.pushDouble(TokenType::MinusMinus);
                        self.char_index += 1;
                    }
                    '=' => {
                        self.pushDouble(TokenType::MinusEquals);
                        self.char_index += 1;
                    }
                ...
                '*' => match self.peakNextChar() {
                    '=' => {
                        self.pushDouble(TokenType::AsteriskEquals);
                        self.char_index += 1;
                    }
                ...
                '/' => match self.peakNextChar() {
                    '=' => {
                        self.pushDouble(TokenType::SlashEquals);
                        self.char_index += 1;
                    }
                ...
                '%' => match self.peakNextChar() {
                    '=' => {
                        self.pushDouble(TokenType::PercentEquals);
                        self.char_index += 1;
                    }
                ...
                '=' => match self.peakNextChar() {
                    '=' => {
                        self.pushDouble(TokenType::EqualsEquals);
                        self.char_index += 1;
                    }
                ...
                '!' => match self.peakNextChar() {
                    '=' => {
                        self.pushDouble(TokenType::NotEquals);
                        self.char_index += 1;
                    }
                ...
                '<' => match self.peakNextChar() {
                    '<' => {
                        self.pushDouble(TokenType::ShiftLeft);
                        self.char_index += 1;
                    }
                    '=' => {
                        self.pushDouble(TokenType::LessEquals);
                        self.char_index += 1;
                    }
                ...
                '>' => match self.peakNextChar() {
                    '>' => {
                        self.pushDouble(TokenType::ShiftRight);
                        self.char_index += 1;
                    }
                    '=' => {
                        self.pushDouble(TokenType::GreaterEquals);
                        self.char_index += 1;
                    }
                ...
                '&' => match self.peakNextChar() {
                    '&' => {
                        self.pushDouble(TokenType::AmpersandAmpersand);
                        self.char_index += 1;
                    }
                    '=' => {
                        self.pushDouble(TokenType::AmpersandEquals);
                        self.char_index += 1;
                    }
                ...
                '|' => match self.peakNextChar() {
                    '|' => {
                        self.pushDouble(TokenType::PipePipe);
                        self.char_index += 1;
                    }
                    '=' => {
                        self.pushDouble(TokenType::PipeEquals);
                        self.char_index += 1;
                    }
                ...
                '^' => match self.peakNextChar() {
                    '=' => {
                        self.pushDouble(TokenType::CaretEquals);
                        self.char_index += 1;
                    }
                ...
                '\'' => {
                    ...
                    self.char_index += 1; // consume closing '''
    ...
    fn readStringLiteral(&mut self) -> String {
        ...
        while !result.ends_with('"') || result.ends_with("\\\"") {
            self.char_index += 1;
            result.push(self.readCharLiteral());
        }
